...
class _FirebaseFunctionsCallableRest
  ...
  @override
  Future<FirebaseFunctionsCallableResultRest<T>> call<T>([
    Object? parameters,
  ]) async {
    ...
    var authUserId = (functionsCallRest.app as FirebaseAppMixin)
        .getProduct<FirebaseAuth>()
        ?.currentUser
        ?.uid;*/
    var uri = this.uri!;
    var headers = <String, String>{
      http.httpHeaderContentType: http.httpContentTypeJson,
    ...
    try {
      ...
      return FirebaseFunctionsCallableResultRest<T>(result as T);
    } catch (e, st) {
